...
<template>
  <div class="container">
    <PictureCard :word="word" :audio="audio" @update-image="update" />
    <div class="output">
      <div>{{ sentence }}</div>
      <div class="details">
        <button @click="datailExpand = !datailExpand"> Talk about it</button>
        <div class="fold" v-if="!datailExpand"></div>
